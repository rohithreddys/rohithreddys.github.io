...
countryOfResidence.addEventListener("change", function () {
  ...
  if (
    ...
    privacyTermsConditions.innerHTML = `I have read and understood the Terms and Conditions in the <a href="#accidental_data_privacy">BPI AIA Privacy Addendum for Mainland China</a>.`;
...
function handleForm(event) {
  ...
  if (
    ...
    $("#customer_Name").text(
      `Hi ${field_firstName}. Hang in there as we process your request. Expect an SMS from us within 7 to 10 working days on the status of your request.`
    );
          ...
          if (event.data?.returnCode == "0") {
            ...
            if (event.data?.accountName != null) {
              ...
              document.getElementById("have_bank_details").innerHTML =
                "Here are your bank details that we have on file. If you wish to update your bank details, click CHANGE BANK ACCOUNT.";
