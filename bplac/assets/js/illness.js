...
countryOfResidence.addEventListener("change", function () {
  ...
  if (
    ...
    privacyTermsConditions.innerHTML = `I have read and understood the Terms and Conditions in the <a href="#illness_data_privacy">BPI AIA Privacy Addendum for for Mainland China</a>.`;
